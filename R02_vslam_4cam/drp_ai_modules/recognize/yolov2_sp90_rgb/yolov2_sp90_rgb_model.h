 ...
 ***********************************************************************************************************************/
/***********************************************************************************************************************
 * File Name    : yolov2_sp90_rgb_model.h
 * Version      : -
 * Description  : RZ/V DRP-AI Sample Application for USB Camera version
 ***********************************************************************************************************************/

#pragma once
#ifndef YOLOV2_SP90_RGB_MODEL_H
#define YOLOV2_SP90_RGB_MODEL_H
...
class YoloV2Sp90RGBModel : public IRecognizeModel {
private:
    constexpr static string_view MODEL_NAME = "YoloV2_sp90_VGA_RGB_0726";
    constexpr static int32_t YOLOV2_SP90_RGB_NUM_BB = 5;
    /* Number of output layers. This value MUST match with the length of num_grids[] below */
    constexpr static int32_t YOLOV2_SP90_RGB_NUM_INF_OUT_LAYER = 1;
    /* Thresholds */
    constexpr static float YOLOV2_SP90_RGB_TH_PROB = 0.4f;
    constexpr static float YOLOV2_SP90_RGB_TH_NMS = 0.5f;
    /* Size of input image to the model */
    constexpr static int32_t YOLOV2_SP90_RGB_MODEL_IN_W = 416;
    constexpr static int32_t YOLOV2_SP90_RGB_MODEL_IN_H = 416;

#if (MODEL_RESOLUTION == 0)
    constexpr static string_view MODEL_DIR = "YoloV2_sp90_VGA_RGB_0726";
    constexpr static int32_t YOLOV2_SP90_RGB_DRPAI_IN_WIDTH = 640;
    constexpr static int32_t YOLOV2_SP90_RGB_DRPAI_IN_HEIGHT = 480;
#endif
