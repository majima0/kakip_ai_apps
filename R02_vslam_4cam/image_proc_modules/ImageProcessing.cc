...
void ImageProcessing::Run() {
    ...
    while (true) {
        if (tracking_ptr_
            ...
            //std::cerr << "second process done" << std::endl;
            //#endif
            ...
            #if defined(ENABLE_DEBUG_OUTPUT)
            std::cerr << "image processing done" << std::endl;
            #endif
...
void ImageProcessing::FirstProcess() {
    ...
    Tcb = *Tcb_ptr_;
    camera_k_ = *camera_k_ptr_;
    dist_coef_ = *dist_coef_ptr_;
...
#endif
        {
            frame_ptr_.reset(new Frame(gray_image_, //tracking_ptr_->mImGray,
                                       Tcb,
                                       timestamp_,
                                       extractor_,
                                       vocabulary_,
    ...
    frame_ptr_->mnCameraId = camera_id_;
