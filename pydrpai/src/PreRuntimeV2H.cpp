...
{
    std::cout << "drpai_obj_info" << std::endl;
    std::cout << "\tdrpai_obj_info.drpai_fd " << this->drpai_obj_info.drpai_fd << std::endl;
    std::cout << "\tdrpai_obj_info.data_inout" << std::endl;
    std::cout << "\t\tdrpai_obj_info.data_inout.directory_name " << this->drpai_obj_info.data_inout.directory_name << std::endl;
    std::cout << "\t\tdrpai_obj_info.data_inout.start_address " << this->drpai_obj_info.data_inout.start_address << std::endl;
    std::cout << "\t\tdrpai_obj_info.data_inout.object_files_size " << this->drpai_obj_info.data_inout.object_files_size << std::endl;
    std::cout << "\t\tdrpai_obj_info.data_inout.data_in_addr " << this->drpai_obj_info.data_inout.data_in_addr << std::endl;
    std::cout << "\t\tdrpai_obj_info.data_inout.data_in_size " << this->drpai_obj_info.data_inout.data_in_size << std::endl;
    std::cout << "\t\tdrpai_obj_info.data_inout.data_out_addr " << this->drpai_obj_info.data_inout.data_out_addr << std::endl;
    std::cout << "\t\tdrpai_obj_info.data_inout.data_out_size " << this->drpai_obj_info.data_inout.data_out_size << std::endl;
    this->drpai_obj_info.data_inout.object_files_size = 0;
    this->drpai_obj_info.data_inout.data_in_addr = 0;
    this->drpai_obj_info.data_inout.data_in_size = 0;
    this->drpai_obj_info.data_inout.data_out_addr = 0;
    this->drpai_obj_info.data_inout.data_out_size = 0;
    this->run_mode = 0;
    this->mapped_in_addr_v2h = 0;
}
...
uint8_t PreRuntime::Load(const std::string pre_dir, uint64_t start_addr)
{
    ...
    std::cout << "Occupied_size " << this->Occupied_size << std::endl;
    std::cout << "internal_param_val.pre_in_shape_w " << this->internal_param_val.pre_in_shape_w << std::endl;
    std::cout << "internal_param_val.pre_in_shape_h " << this->internal_param_val.pre_in_shape_h << std::endl;
    std::cout << "internal_param_val.pre_in_addr " << this->internal_param_val.pre_in_addr << std::endl;
    std::cout << "internal_param_val.pre_in_format " << this->internal_param_val.pre_in_format << std::endl;
    std::cout << "internal_param_val.pre_out_format " << this->internal_param_val.pre_out_format << std::endl;
    std::cout << "internal_param_val.resize_alg " << this->internal_param_val.resize_alg << std::endl;
    std::cout << "internal_param_val.resize_w " << this->internal_param_val.resize_w << std::endl;
    std::cout << "internal_param_val.resize_h " << this->internal_param_val.resize_h << std::endl;
    std::cout << "internal_param_val.cof_add " << this->internal_param_val.cof_add[0] << " " << this->internal_param_val.cof_add[1] << " " << this->internal_param_val.cof_add[3] << std::endl;
    std::cout << "internal_param_val.cof_mul " << this->internal_param_val.cof_mul[0] << " " << this->internal_param_val.cof_mul[1] << " " << this->internal_param_val.cof_mul[3] << std::endl;
    std::cout << "internal_param_val.crop_tl_x " << this->internal_param_val.crop_tl_x << std::endl;
    std::cout << "internal_param_val.crop_tl_y " << this->internal_param_val.crop_tl_y << std::endl;
    std::cout << "internal_param_val.crop_w " << this->internal_param_val.crop_w << std::endl;
    std::cout << "internal_param_val.crop_h " << this->internal_param_val.crop_h << std::endl;
    std::cout << "internal_buffer " << this->internal_buffer << std::endl;
    std::cout << "internal_buffer_size " << this->internal_buffer_size << std::endl;
    std::cout << "drpai_obj_info" << std::endl;
    std::cout << "\tdrpai_obj_info.drpai_fd " << this->drpai_obj_info.drpai_fd << std::endl;
    std::cout << "\tdrpai_obj_info.data_inout" << std::endl;
    std::cout << "\t\tdrpai_obj_info.data_inout.directory_name " << this->drpai_obj_info.data_inout.directory_name << std::endl;
    ...
    std::cout << "\t\tdrpai_obj_info.data_inout.data_out_addr " << this->drpai_obj_info.data_inout.data_out_addr << std::endl;
    std::cout << "\t\tdrpai_obj_info.data_inout.data_out_size " << this->drpai_obj_info.data_inout.data_out_size << std::endl;
    std::cout << "\tdrpai_obj_info.drpai_address" << std::endl;
    std::cout << "\t\tdrpai_obj_info.drpai_address.desc_aimac_addr " << this->drpai_obj_info.drpai_address.desc_aimac_addr << std::endl;
    std::cout << "\t\tdrpai_obj_info.drpai_address.desc_aimac_size " << this->drpai_obj_info.drpai_address.desc_aimac_size << std::endl;
    std::cout << "\t\tdrpai_obj_info.drpai_address.desc_drp_addr " << this->drpai_obj_info.drpai_address.desc_drp_addr << std::endl;
    std::cout << "\t\tdrpai_obj_info.drpai_address.desc_drp_size " << this->drpai_obj_info.drpai_address.desc_drp_size << std::endl;
    std::cout << "\t\tdrpai_obj_info.drpai_address.drp_param_addr " << this->drpai_obj_info.drpai_address.drp_param_addr << std::endl;
    std::cout << "\t\tdrpai_obj_info.drpai_address.drp_param_size " << this->drpai_obj_info.drpai_address.drp_param_size << std::endl;
    std::cout << "\t\tdrpai_obj_info.drpai_address.data_in_addr " << this->drpai_obj_info.drpai_address.data_in_addr << std::endl;
    std::cout << "\t\tdrpai_obj_info.drpai_address.data_in_size " << this->drpai_obj_info.drpai_address.data_in_size << std::endl;
    std::cout << "\t\tdrpai_obj_info.drpai_address.data_addr " << this->drpai_obj_info.drpai_address.data_addr << std::endl;
    std::cout << "\t\tdrpai_obj_info.drpai_address.data_size " << this->drpai_obj_info.drpai_address.data_size << std::endl;
    std::cout << "\t\tdrpai_obj_info.drpai_address.work_addr " << this->drpai_obj_info.drpai_address.work_addr << std::endl;
    std::cout << "\t\tdrpai_obj_info.drpai_address.work_size " << this->drpai_obj_info.drpai_address.work_size << std::endl;
    std::cout << "\t\tdrpai_obj_info.drpai_address.data_out_addr " << this->drpai_obj_info.drpai_address.data_out_addr << std::endl;
    std::cout << "\t\tdrpai_obj_info.drpai_address.data_out_size " << this->drpai_obj_info.drpai_address.data_out_size << std::endl;
    std::cout << "\t\tdrpai_obj_info.drpai_address.drp_config_addr " << this->drpai_obj_info.drpai_address.drp_config_addr << std::endl;
    std::cout << "\t\tdrpai_obj_info.drpai_address.drp_config_size " << this->drpai_obj_info.drpai_address.drp_config_size << std::endl;
    std::cout << "\t\tdrpai_obj_info.drpai_address.weight_addr " << this->drpai_obj_info.drpai_address.weight_addr << std::endl;
    std::cout << "\t\tdrpai_obj_info.drpai_address.weight_size " << this->drpai_obj_info.drpai_address.weight_size << std::endl;
    std::cout << "\t\tdrpai_obj_info.drpai_address.aimac_param_cmd_addr " << this->drpai_obj_info.drpai_address.aimac_param_cmd_addr << std::endl;
    std::cout << "\t\tdrpai_obj_info.drpai_address.aimac_param_cmd_size " << this->drpai_obj_info.drpai_address.aimac_param_cmd_size << std::endl;
    std::cout << "\t\tdrpai_obj_info.drpai_address.aimac_param_desc_addr " << this->drpai_obj_info.drpai_address.aimac_param_desc_addr << std::endl;
    std::cout << "\t\tdrpai_obj_info.drpai_address.aimac_param_desc_size " << this->drpai_obj_info.drpai_address.aimac_param_desc_size << std::endl;
    std::cout << "\t\tdrpai_obj_info.drpai_address.aimac_cmd_addr " << this->drpai_obj_info.drpai_address.aimac_cmd_addr << std::endl;
    std::cout << "\t\tdrpai_obj_info.drpai_address.aimac_cmd_size " << this->drpai_obj_info.drpai_address.aimac_cmd_size << std::endl;
    std::cout << "drpai_data0" << std::endl;
    std::cout << "\tdrpai_data0.address " << this->drpai_data0.address << std::endl;
    std::cout << "\tdrpai_data0.size " << this->drpai_data0.size << std::endl;
    std::cout << "obj_prefix " << this->obj_prefix << std::endl;
    std::cout << "param_data.size " << this->param_data.size() << std::endl;
    for (const auto& p : this->param_data) {
        std::cout << "\tparam_data " << p << std::endl;
    }
    std::cout << "weight_data.size " << this->weight_data.size() << std::endl;
    for (const auto& w : this->weight_data) {
        std::cout << "\tweight_data" << w << std::endl;
    }
    std::cout << "param_info.size " << this->param_info.size() << std::endl;
    for (const s_op_t& p : param_info) {
        std::cout << "\tparam_info.name " << p.name << std::endl;
        std::cout << "\tparam_info.lib " << p.lib << std::endl;
        std::cout << "\tparam_info.offset " << p.offset << std::endl;
        std::cout << "\tparam_info.param_list.size " << p.param_list.size() << std::endl;
        for (const s_op_param_t& s : p.param_list) {
            std::cout << "\t\tparam_info.param_list.name " << s.name << std::endl;
            std::cout << "\t\tparam_info.param_list.value " << s.value << std::endl;
            std::cout << "\t\tparam_info.param_list.offset " << s.offset << std::endl;
            std::cout << "\t\tparam_info.param_list.size " << s.size << std::endl;
        }
    }
    std::cout << "run_mode " << this->run_mode << std::endl;
    std::cout << "pre_out_shape_w " << this->pre_out_shape_w << std::endl;
    std::cout << "pre_out_shape_h " << this->pre_out_shape_h << std::endl;
    std::cout << "pre_in_shape_c " << this->pre_in_shape_c << std::endl;
    std::cout << "pre_out_shape_c " << this->pre_out_shape_c << std::endl;
    std::cout << "pre_in_type_size " << this->pre_in_type_size << std::endl;
    std::cout << "pre_out_type_size " << this->pre_out_type_size << std::endl;
    std::cout << "crop_included " << this->crop_included << std::endl;
    std::cout << "resize_included " << this->resize_included << std::endl;
    std::cout << "normalize_included " << this->normalize_included << std::endl;
    std::cout << "start_addr_v2h " << this->start_addr_v2h << std::endl;
    std::cout << "mapped_in_addr_v2h " << this->mapped_in_addr_v2h << std::endl;
    return PRE_SUCCESS;
}
